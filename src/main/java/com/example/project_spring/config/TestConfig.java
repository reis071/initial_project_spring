...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order firtstOrder = new Order(null, Instant.parse("2024-06-24T21:40:08Z"),firstUser);
        Order secondOrder = new Order(null, Instant.parse("2024-06-24T21:40:08Z"),secondUser);
